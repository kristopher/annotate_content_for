...
Optionally Adds a Content For Note to Footnotes if your using drnic's <a href=http://github.com/drnic/rails-footnotes/tree/master>rails-footnotes</a> plugin. 
